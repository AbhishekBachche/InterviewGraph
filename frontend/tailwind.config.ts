    ...
    extend: {
      ...
      colors: {
        ...
        palette: {
          ...
          button: "var(--palette-button)",
          "button-hover": "var(--palette-button-hover)",
          heading: "var(--palette-heading)",
      ...
      boxShadow: {
        card: "0 4px 16px rgba(15, 23, 42, 0.06), 0 12px 32px rgba(15, 23, 42, 0.04)",
        elevated: "0 8px 28px rgba(15, 23, 42, 0.08), 0 24px 48px rgba(15, 23, 42, 0.06)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
